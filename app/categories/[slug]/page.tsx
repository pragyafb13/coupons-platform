    ...
    <div className="min-h-screen bg-gradient-to-b from-gray-50 to-white">
      ...
      <section className="bg-gradient-to-br from-purple-500 via-purple-600 to-indigo-600 text-white py-16 sm:py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <Link
            href="/categories"
            className="inline-flex items-center gap-2 text-white/80 hover:text-white mb-6 font-medium transition group"
          >
              ...
              {allCoupons.map((coupon) => {
                ...
                return (
                  ...
                  >
                    ...
                    {/* Expiry Date */}
                    {coupon.expiryDate && (
                      <div className="flex items-center gap-2 text-sm text-gray-600 bg-gray-50 rounded-lg px-3 py-2 mb-6">
